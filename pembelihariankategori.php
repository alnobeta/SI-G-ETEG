    ...
    <section class="intro">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 " >
                <h1 style="color:black; margin-top:-10px; text-align:left; margin-left:40px; font-weight:bold;">
                    <?php
                    ...
                    for ($i=0; $i < $banyak; $i++) { 
                        for ($j=1; $j <= 3; $j++) { 
                            while ($dataproduk = mysql_fetch_array($q1)) {
                                ...
                                echo "<legend></legend>";
                                echo "<a href=\"?halaman=$getid&id=$id&#popup\" class=\"popup-link\"><p style=\"color:black; font-size:15px; margin-left:-4px;\">Baca Selengkapnya</p></a>";
                                echo "</div>";
                                echo "</div>";
                                echo "</div>";
                                echo "</div>";
    ...
    <div class="popup-wrapper" id="popup">
        <div class="popup-container">
            ...
            <form action="pesan.php" method="POST" class="popup-form">
                ...
                <?php echo "<a class=\"popup-close\" href=\"pembelihariankategori.php?halaman=$idhalaman\">X</a>";?>
            </form>
        </div>
    </div> 
    <!-- jQuery -->
